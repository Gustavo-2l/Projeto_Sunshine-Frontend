...
<div className="flex items-start space-x-3 max-w-[80%]">
<div className="w-8 h-8 rounded-full bg-accent text-dark flex items-center justify-center">
<Bot size={16} />
</div>
...
<span className="text-red-700">{error}</span>
      ...
      {/* Quick Actions */}
<div className="mt-6">
<h3 className="text-lg font-semibold text-light mb-3">Perguntas Sugeridas</h3>
